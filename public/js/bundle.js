...
var displayMap = function displayMap(locations) {
  mapboxgl.accessToken = 'pk.eyJ1IjoicHJhaGFyc2g5OSIsImEiOiJja2J1cTRheHEwNWw0MnlxYzJmcHR1N3J2In0.xmwsXjuym7FA5T0YRHFphQ';
...
var updateSettings = /*#__PURE__*/function () {
  var _ref = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee(data, type, reload) {
    var url, res;
    return regeneratorRuntime.wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
...
var stripe = window.Stripe('pk_test_51GzSBeFyUruRvBaubtQLTM8nxeooQDDlQN1hizgVmv8JdMd6Raffnpzem89NKacC2jZG7D0wkiNySE5fssFL2wWh00NouMwr9p');
...
if (userDataForm) {
  userDataForm.addEventListener('submit', function (e) {
    ...
    (0, _updateSettings.updateSettings)(form, 'data', true);
  });
}
...
if ((!parent || !parent.isParcelRequire) && typeof WebSocket !== 'undefined') {
  ...
  var ws = new WebSocket(protocol + '://' + hostname + ':' + "10964" + '/');
